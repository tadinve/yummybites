			...
			<div class="banner padd">
				<div class="container">
					...
					<ol class="breadcrumb">
						...
						<li><a href="http://localhost/ci/index.php/upload/img_display">Shopping</a></li>
						...
						<div class="single-item-content">
							<div class="row">
								<div class="col-md-4 col-sm-5">
									<!-- Product image -->
									<img class="img-responsive img-thumbnail" src="img/9.jpg" alt="" />
								</div>
									...
									<div class="row">
										<div class="col-md-7 col-sm-12">
											...
											<div class="item-details">
												<!-- Paragraph -->
												<p class="text-justify">Indulgence!! We don't need a reason for this.. Let your dear one's heart melt with our chocolate cake at the very bite they make!!</p>
												<!-- Heading -->
												<h5>Ingredients-</h5>
												...
												<ul class="list-unstyled">
													...
													<li>
														<i class="fa fa-check"></i> chocolate <span class="pull-right"> 200g</span>
														<div class="clearfix"></div>
													</li>
													<li>
