					...
					<div class="header-top">
						...
						<div class="row">
							...
							<a href="index.html">
								<!-- Logo area -->
								<div class="logo">
									<img class="img-responsive" src="img/lo.png" alt="" />
								...
								<div class="container-fluid">
									...
									<div class="collapse navbar-collapse pull-left" id="bs-example-navbar-collapse-1">
										...
										<ul class="nav navbar-nav">
											...
											<li class="dropdown">
												<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="img/nav-menu/nav4.jpg" class="img-responsive" alt="" /> Menu <b class="caret"></b></a>
												<ul class="dropdown-menu">
													<li><a href="menu.html">Flower Bouquet Cake</a></li>
													<li><a href="menu.html">Valentine Heart Shaped Cake</a></li>
													<li><a href="menu.html">Cartoon Cake with Edible Print</a></li>
													
													<li><a href="menu.html">Edible Photo Cake</a></li>
													
													<li><a href="menu.html">Engagement Cake</a></li>
													<li><a href="menu.html">Fruit Topping Cake</a></li>
											...
											<li class="dropdown">
												...
												<ul class="dropdown-menu">
													<li><a href="<?php echo $this->config->base_url().'upload/img_display' ?>">Shopping</a></li>
					...
					<ul>	<!-- SLIDE  -->
                    	<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
							...
							<div class="tp-caption customin customout"
								...
								data-easing="Power4.easeOut"
								data-endspeed="500"
								style="z-index: 5"><img class="slide-img img-responsive" src="img/slider/flower.png" alt style="width: 250px; height: 250px;" />
							</div>
							<!-- LAYER NR. 2.1 -->
							...
							<div class="tp-caption customin customout"
								...
								data-endspeed="500"
								data-endeasing="Power4.easeIn"
								style="z-index: 6"><img class="slide-img img-responsive" src="img/slider/choclate.png" alt style="width: 250px; height: 250px;" />
							</div>
							<!-- LAYER NR. 2.2 -->
							...
							<div class="tp-caption customin customout"
								...
								data-endspeed="500"
								style="z-index: 7"><img class="slide-img img-responsive" src="img/slider/cartoon.png" alt style="width: 250px; height: 250px;" />
							</div>
							<!-- LAYER NR. 2.3 -->
							...
							<div class="tp-caption customin customout"
								...
								data-easing="Power3.easeInOut"
								data-endspeed="500"
								style="z-index: 8"><img class="slide-img img-responsive" src="img/slider/fruit.png" alt style="width: 250px; height: 250px;" />
							</div>
							</li>
						...
						<li data-transition="cube" data-slotamount="7" data-masterspeed="600" >
							<!-- MAIN IMAGE -->
							<img src="img/galary/15.png"  alt=""  data-bgfit="cover" data-bgposition="center bottom" data-bgrepeat="no-repeat">
							<!-- LAYERS -->
							<!-- LAYER NR. 1 -->
							...
							<div class="tp-caption customin customout"
								...
								data-easing="Power4.easeOut"
								data-endspeed="500"
								style="z-index: 5"><img class="slide-img img-responsive" src="img/galary/26.png" alt style="width: 250px; height: 250px;" />
							</div>
							<!-- LAYER NR. 2.1 -->
							<div class="tp-caption customin customout"
								data-x="right" data-hoffset="-10"
								...
								data-easing="Power3.easeInOut"
								data-endspeed="500"
								style="z-index: 7"><img class="slide-img img-responsive" src="img/galary/7.png" alt style="width: 250px; height: 250px;" />
							</div>
							<!-- LAYER NR. 2.2 -->
							<div class="tp-caption customin customout"
								data-x="right" data-hoffset="-120"
								...
								data-endspeed="500"
								data-endeasing="Power4.easeIn"
								style="z-index: 6"><img class="slide-img img-responsive" src="img/galary/9.png" alt style="width: 250px; height: 250px;" />
							</div>
						...
						<li data-transition="cube" data-slotamount="7" data-masterspeed="600" >
							<!-- MAIN IMAGE -->
							<img src="img/galary/dd.png"  alt=""  data-bgfit="cover" data-bgposition="center bottom" data-bgrepeat="no-repeat">
							<!-- LAYERS -->
							<!-- LAYERS NR. 1 -->
						...
						<li data-transition="cube" data-slotamount="7" data-masterspeed="600" >
							...
							<div class="tp-caption lfl"
								...
								data-endspeed="300"
								data-endeasing="Power4.easeIn"
								data-captionhidden="off"><img src="img/galary/des.png" class="img-responsive" alt style="width: 500px; height: 400px;" />
							</div>
							<!-- LAYERS NR. 2 -->
							<div class="tp-caption lfl"
								data-x="80"
								...
								data-endspeed="300"
								data-endeasing="Power4.easeIn"
								data-captionhidden="off"><img src="img/galary/ttab.png" class="img-responsive" alt="" />
							</div>
							<!-- LAYERS NR. 3 -->
							<div class="tp-caption lfl"
								data-x="450"
								...
								data-endspeed="300"
								data-endeasing="Power4.easeIn"
								data-captionhidden="off"><img src="img/galary/tab.png" class="img-responsive" alt="" />
							</div>
							<!-- LAYERS NR. 4 -->
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6">
							...
							<div class="footer-widget">
								...
								<h4>Famous Cakes</h4>
								<!-- Images -->
								<a href="#"><img class="dish img-responsive" src="img/galary/1.png" alt="" /></a>
								<a href="#"><img class="dish img-responsive" src="img/galary/2.png" alt="" /></a>
								<a href="#"><img class="dish img-responsive" src="img/galary/5.png" alt="" /></a>
								<a href="#"><img class="dish img-responsive" src="img/galary/7.jpg" alt="" /></a>
								<a href="#"><img class="dish img-responsive" src="img/galary/9.jpg" alt="" /></a>
								<a href="#"><img class="dish img-responsive" src="img/galary/22.jpg" alt="" /></a>
								<a href="#"><img class="dish img-responsive" src="img/galary/23.png" alt="" /></a>
								<a href="#"><img class="dish img-responsive" src="img/galary/27.jpg" alt="" /></a>
								<a href="#"><img class="dish img-responsive" src="img/galary/26.jpg" alt="" /></a>
							</div> <!--/ Footer widget end -->
						</div>
