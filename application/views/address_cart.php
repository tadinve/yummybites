...
<div id="row">
    <div class="header">Welcome to Yummybites' Bakery</div>
<p><strong>Please Note : </strong></p>

<p><strong>1. Minimum Amount of shopping cart is ₹300.</strong></p>


<p><strong>2. Please place your order before 3 PM a day in advance for delivery in the morning slot ( 7 AM - 11 AM ). Do not select morning slots for same day delivery.</strong></p>
        <!-- Checkout Start -->
  ...
  <br>
  <br>
  <span class="required">*</span> Mobile:<br>
...
<div class="right">
  ...
  <br>
  <br>
  <div style="display: none;"> Business Type:<br>
  ...
  <div id="company-id-display"><span id="company-id-required" class="required" style="display: none;">*</span> Company ID:<br>
    <input type="text" name="company_id" value="" class="large-field">
    <br>
    <br>
  </div>
  <div id="tax-id-display" style="display: none;"><span id="tax-id-required" class="required">*</span> Tax ID:<br>
  ...
  <br><span class="error">Service is not Available at your location yet</span>
  <br>
...
<div class="buttons">
  <div class="right">
    <input type="button" value="Continue" id="button-guest" class="button">
  </div>
</div>
