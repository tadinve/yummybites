 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'reethi_api1.solivarindia.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '3MP8RJ5NWQA5CB4Y' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'Ae0lmoUGEiwMcx7glI8FXj4n.CiwAOfx7MddCM0mfpzKQOJRoy26oDOQ' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['PayFlowUsername'] = $config['Sandbox'] ? 'reethi' : 'PRODUCTION_USERNAME_GOGES_HERE';
$config['PayFlowPassword'] = $config['Sandbox'] ? 'reethimaveni.211' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['PayFlowVendor'] = $config['Sandbox'] ? 'reethi' : 'PRODUCTION_VENDOR_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = 'reethi@solivarindia.com';
